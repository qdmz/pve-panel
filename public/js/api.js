...
(function () {
  ...
  window.API = {
    ...
    transferVm(id, userId) { return adminApi('/vms/' + id + '/transfer', { method: 'POST', body: { user_id: userId } }); },
    getVmDetail(id) { return adminApi('/vms/' + id); },
    getIpPools(params) { return adminApi('/ip-pools', { params: params }); },
    getIpPool(id) { return adminApi('/ip-pools/' + id); },
    createIpPool(data) { return adminApi('/ip-pools', { method: 'POST', body: data }); },
    updateIpPool(id, data) { return adminApi('/ip-pools/' + id, { method: 'PUT', body: data }); },
    deleteIpPool(id) { return adminApi('/ip-pools/' + id, { method: 'DELETE' }); },
    getPoolAddresses(id) { return adminApi('/ip-pools/' + id + '/addresses'); },
    allocateIp(poolId, vmId) { return adminApi('/ip-pools/' + poolId + '/allocate', { method: 'POST', body: { vm_id: vmId } }); },
    releaseIp(id) { return adminApi('/ip-addresses/' + id + '/release', { method: 'POST' }); },
